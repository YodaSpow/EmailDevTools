$(window).on("load", function() {
  ...
  $(document).ready(function() {         
    $(".iT, .fT, .spT, .icon").removeAttr("href");
  });  
...
// Responsive hamburger: https://www.w3schools.com/howto/tryit.asp?filename=tryhow_js_topnav  
...
(function() {
  ...
  navList.children[6].className = "icon dN"; // dN hides navItems CSS
